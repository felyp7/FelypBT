...
const client = new tmi.Client({    
    ...
    channels: ["opat04", "meiiodaas", "xpatrck", "yamatosdeath1", "sneeeze_","matysek__", "fookstee", "carltincan", "turtoise", "anniiikaa", "bobthebuilder_98", "pajlada", "masenka12", "scarder_", "lukyjuk", "godfelyp1", "lordevid", "kawanpls", "speedster05", "feelsdonkman", "lul85xd__"]
});
