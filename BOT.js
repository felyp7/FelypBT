...
const client = new tmi.Client({    
    ...
    channels: ['godfelyp1', 'scarder_', 'bobthebuilder_98', 'Fookstee', 'florian_2807', 'veryracc', 'xPatrck', 'masenka12', 'lordevid', 'Sneeeze_', 'kawanpls', 'turtoise', 'anniiikaa', 'pajlada', 'carltincan']
});
